                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">User Register</h3>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="<?= base_url('C_bagusAuth/registerUser') ?>">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="<?= base_url('C_bagusAuth/loginUser') ?>">Have an
